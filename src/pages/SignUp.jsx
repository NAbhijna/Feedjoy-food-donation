         ...
         <input 
          ...
          <div className="relative mb-6">
           <input
             ...
             placeholder="Password"className="w-full px-4 py-2 text-x1 text-dark-olive bg-cream border-golden-yellow rounded-2xl transition ease-in-out"/>
          ...
          <div className="flex justify-between whitespace-nowrap text-sm sm:text-lg">
            <p className="mb-6 text-dark-olive">Have an account?
            <Link to="/sign-in" className="text-golden-yellow hover:text-burnt-orange transition duration-200 ease-in-out ml-1">Sign In
            </Link>
            </p>
            <p className="text-dark-olive">
              <Link to="/forgot-password"className="text-olive-green hover:text-dark-olive
